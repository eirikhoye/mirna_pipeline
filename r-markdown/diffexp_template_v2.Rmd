...
source(paste(project_dir, 'scripts/deseq_functions.R', sep=""))
```
...
MirGeneDB_info <- read_delim(paste(project_dir, 'data/hsa_MirGeneDB_to_miRBase.csv', sep=""), delim = ';')
...
sampleinfo <- read_csv(paste(project_dir, "data/sample_info_tutorial.csv", sep=""))
sampleinfo <- sampleinfo %>% filter(qc_report == 'keep') # keep only samples that passed qc

# Read the data into R
seqdata <- read_delim(paste(project_dir, "mirge_output/miRge.2021-09-01_15-21-59/miR.Counts.csv", sep=""), delim = ',')
